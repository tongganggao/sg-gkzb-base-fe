...
// ) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='供应商档案：供应商基本信息 (bd_supplier) ';
  meta: {
    id: '',
    code: { type:'String', required: true, nullMsg: '请输入供应商编码'},
    name: { type:'String', required: true, nullMsg: '请输入供应商名称'},
    orgId: { type:'String', required: true, nullMsg: '请选择所属组织'},
    orgCode: '',
    orgName: '',
    shortname: '',
    supplierclassId: { type:'String', required: true, nullMsg: '请选择供应商分类'},
    supplierclassCode: '',
    supplierclassName: '',
    iscustomer: '',
    enablestate: '',
